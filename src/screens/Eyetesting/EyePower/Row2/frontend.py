from tkinter import *
from src.screens.Eyetesting.EyePower.Row3.frontend import Row3
from src.screens.Eyetesting.EyePower.Row2.backend import results
...
class Row2:
    def __init__(self,root, Interface_Frame, Interface_Label, Interface_Button):
        ...
        Interface_Label(self.eyePowerScreen, "src/images/frontend/Visual Acuity/Row2.png",450, 300, CENTER, "white", 397, 179)

        # Next Button
        Interface_Button(
            self.eyePowerScreen, "src/images/frontend/Onboarding/Button.png", 150, 39, "white", FLAT, 350, 530, CENTER, lambda: Row3(root, Interface_Frame, Interface_Label, Interface_Button))
