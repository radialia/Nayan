from tkinter import *
from src.screens.Eyetesting.EyePower.Row10.frontend import Row10
from src.screens.Eyetesting.EyePower.Row9.backend import results
...
class Row9:
    def __init__(self,root, Interface_Frame, Interface_Label, Interface_Button):
        ...
        Interface_Label(self.eyePowerScreen, "src/images/frontend/Visual Acuity/Row9.png",450, 300, CENTER, "white", 372, 45)

        # Next Button
        Interface_Button(
            self.eyePowerScreen, "src/images/frontend/Onboarding/Button.png", 150, 39, "white", FLAT, 350, 530, CENTER, lambda: Row10(root, Interface_Frame, Interface_Label, Interface_Button))
