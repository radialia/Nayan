from tkinter import *
from src.screens.Eyetesting.EyePower.Row11.frontend import Row11
from src.screens.Eyetesting.EyePower.Row10.backend import results
...
class Row10:
    def __init__(self,root, Interface_Frame, Interface_Label, Interface_Button):
        ...
        Interface_Label(self.eyePowerScreen, "src/images/frontend/Visual Acuity/Row10.png",450, 300, CENTER, "white", 309, 36)

        # Next Button
        Interface_Button(
            self.eyePowerScreen, "src/images/frontend/Onboarding/Button.png", 150, 39, "white", FLAT, 350, 530, CENTER, lambda: Row11(root, Interface_Frame, Interface_Label, Interface_Button))
